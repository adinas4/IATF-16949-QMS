  ...
  return <section className="space-y-6">
    ...
    {draft && <div className="rounded-2xl border dark:border-slate-700 bg-white dark:bg-slate-900 p-5 space-y-5">
      ...
      {draft.answers.map((answer, index) => {
        ...
        return <fieldset key={answer.id || index} disabled={!editable} className="border dark:border-slate-700 rounded-xl p-4 space-y-3"><legend className="font-semibold px-2">{index + 1}. {answer.question}</legend>
